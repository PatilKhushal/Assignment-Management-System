		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				...
				<form action="Admin Login.php" method="post">
					<div class="sign-u">
						<input type="text" placeholder="Enter User-Name" required name = "user" value = "<?php echo htmlspecialchars($PreFormUserName);?>" maxlength = 20>
						<span class="glyphicon form-control-feedback" aria-hidden="true"><?php echo htmlspecialchars($UsernameMessage);?></span>
						<div class="clearfix"></div>
					</div>
					
					<div class="sign-u">
						<input type="password" placeholder="Password" required name = "password" value = "<?php echo htmlspecialchars($PreFormPassword);?>" maxlength = 20> 
		...
		<?php
			...
			if(isset($_POST['SignIn']))
			{
				...
				{	
					...
					echo "<script>";
					echo "window.location.href = 'Admin Login.php?UserName=$FormUserName&Password=$FormPassword&failureUserName=$failUserName&failurePassword=$failPassword';";
					echo "</script>";
				}
				else
				{
